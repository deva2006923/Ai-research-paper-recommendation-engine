...
const Ferrofluid = ({
  ...
  useEffect(() => {
    ...
    console.log("Ferrofluid mounting. Container dimensions:", container.clientWidth, "x", container.clientHeight);
    let renderer;
    try {
      ...
      console.error("Failed to create OGL WebGL Renderer:", e);
      return;
    }

    const gl = renderer.gl;
    if (!gl) {
      console.error("WebGL context not available from Renderer!");
      return;
    }
    ...
    console.log("Ferrofluid Canvas appended successfully.");
